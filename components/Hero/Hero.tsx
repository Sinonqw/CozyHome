    ...
    <section className="relative h-[600px] md:h-[700px] bg-[#FBF0E6] overflow-hidden shadow-inner shadow-[#261C1A]/5">
      <div className="container mx-auto px-6 h-full flex items-center justify-start relative z-10">
        <div className="max-w-xl text-[#261C1A] py-12">
          ...
          {/* Кнопка */}
          <button className="bg-[#7C5840] text-[#FBF0E6] shadow-lg shadow-[#7C5840]/50 hover:bg-[#261C1A] hover:shadow-xl hover:shadow-[#261C1A]/50 active:translate-y-0.5 active:shadow-md font-bold py-3 px-8 rounded-xl uppercase tracking-wider transition-all duration-300 ease-in-out">
            Дивитись каталог
          </button>
        </div>
      </div>
